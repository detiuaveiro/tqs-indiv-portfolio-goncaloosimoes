...
class TqsCalculatorTest {
    ...
    void exp() {
        ...
        log.debug("Testing exponential method in {}", t.getClass().getName());

        assertEquals(8, t.exp(2, 3));
        assertEquals(64, t.exp(8, 2));
    }

    @org.junit.jupiter.api.Test
    void sqrt() {
        TqsCalculator t = new TqsCalculator();
        log.debug("Testing sqrt method in {}", t.getClass().getName());

        assertEquals(12, t.sqrt(144));
        assertEquals(9, t.sqrt(81));
    }
